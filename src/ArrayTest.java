public class ArrayTest {
    public static void main(String[] args) {
        ...
        /* 배열을 선언하는 방법
           ...
           2. 데이터 타입 뒤에 '[]' 대괄호를 배치한다.

           3. 변수명을 적어주듯이 배열의 이름을 적어 준다.
              (이것도 역시 구별이 가능하게 적어 주는 것이 좋다.)

           4. 마지막으로 ';' 를 붙여서 마무리한다.

            int[] scores;
            int 형의 데이터를 여러 개 사용할 겁니다.
            그리고 그 대표격의 이름을 scores 로 사용할 것 입니다.
            저는 여러 개의 int 를 배치할 수 있는 변수를 사용하겠습니다.
